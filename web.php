...
body::before{
    ...
    radial-gradient(circle at bottom right,#ff006622,transparent 30%);
    z-index:-1;
}
...
<p>
Learn HTML, CSS, JavaScript, PHP and full-stack web development technologies.
</p>
...
<p>
Learn responsive UI design using HTML, CSS and JavaScript.
</p>
...
<p>
Create real-world web projects with authentication and database integration.
</p>
...
This workshop provides complete practical exposure to modern web technologies with real-world project development.
